...
for source, destination, weight in [
    ("cormorant-garamond-latin-var.woff2", "cormorant-garamond-display-var.woff2", None),
    ("cormorant-garamond-latin-var.woff2", "cormorant-garamond-display-light.woff2", 300),
    ("cormorant-garamond-italic-latin-var.woff2", "cormorant-garamond-display-italic.woff2", 300),
    ("hankengrotesk-latin-var.woff2", "hankengrotesk-interface-var.woff2", (300, 700)),
]:
