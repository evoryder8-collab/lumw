...
const de: typeof en.ui = {
  ...
  optional: 'Optional', requestTitle: 'Ihre Auszeit beginnt hier.',
  ...
  signature: 'Die Signature-Erfahrung', studio: 'Ihre persönliche Auszeit in Buxtehude',
...
export function navigation(locale: Locale) {
  const names = locale === 'de' ? ['MEINE ANGEBOTE & PREISE', 'UBER MICH', 'FAQ', 'KONTAKT'] : translations[locale].nav;
